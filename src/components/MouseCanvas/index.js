...
const MouseCanvas = () => {
  ...
  return (
    <div>
      <canvas id='canvas' style={{overflow:"hidden",minHeight:"100vh",backgroundRepeat:"repeat-y", backgroundImage:"url(https://d33wubrfki0l68.cloudfront.net/daac8858fd4a0ccea44f59dfd079c3c16c263f33/c157c/assets/svg/common-bg.svg)"}}/>
    </div>
  )
}
